  ...
  <li>
    ...
    <details>
      ...
      <div align="left">
        ...
        <p><strong>What I did.</strong> I extracted golden source data from the source system and ran an automated script that identified more than 20,000 account records missing key information. I analyzed the geographic distribution to identify states with the highest concentrations of defective records and prioritize remediation.</p>
